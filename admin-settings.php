...
<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row"><?php echo esc_html__('Welcome Message', 'chatbudgie'); ?></th>
                <td>
                    <input type="text" name="chatbudgie_welcome_message" value="<?php echo esc_attr(get_option('chatbudgie_welcome_message', __('How can I help you today?', 'chatbudgie'))); ?>" class="regular-text" />
                    <p class="description"><?php echo esc_html__('The first message users see when they open the chat.', 'chatbudgie'); ?></p>
                </td>
            </tr>
        <tr valign="top">
